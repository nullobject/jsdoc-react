...
module.exports = {
  ...
  findChildFunctions: function (db, as) {
    const p = F.whereAll([isPublic, kind('function'), memberOf(as)])
    return run(db, p)
  }
}
